...
DROP PROCEDURE IF EXISTS sp_fact_line_list_re_test_query_v2;

CREATE PROCEDURE sp_fact_line_list_re_test_query_v2(IN REPORT_START_DATE DATE, IN REPORT_END_DATE DATE)
BEGIN
WITH ReTest as (select re_test.encounter_id,
                           re_test.client_id,
                           re_test.date_enrolled_in_care,
