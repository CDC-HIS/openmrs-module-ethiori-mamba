...
SELECT dc.patient_name AS 'Patient Name', dc.patient_uuid AS 'UUID', CAST(dc.mrn AS CHAR(20)) AS 'MRN', dc.UAN,
       dc.Sex,
       dc.date_of_birth AS 'Date of Birth', dc.date_of_birth AS 'Date of Birth EC.', ai.art_start_date AS 'ART Start Date',
