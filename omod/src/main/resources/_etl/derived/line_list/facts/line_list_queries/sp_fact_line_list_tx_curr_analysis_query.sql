...
DROP PROCEDURE IF EXISTS sp_fact_line_list_tx_curr_analysis_query_v2;

CREATE PROCEDURE sp_fact_line_list_tx_curr_analysis_query_v2(IN REPORT_START_DATE DATE, IN REPORT_END_DATE DATE,
                                                          IN REPORT_TYPE VARCHAR(50))
BEGIN
DECLARE tx_curr_base_query TEXT;
    DECLARE final_select_query TEXT;
