...
CREATE PROCEDURE sp_fact_line_list_providers_view_query(IN TYPE_OF_CLIENT VARCHAR(50), IN START_DATE DATE, IN END_DATE DATE,
                                IN START_NV_DATE DATE, IN END_NV_DATE DATE, IN PATIENT_GUID VARCHAR(50))
BEGIN
...
WITH FollowUp as (select follow_up.encounter_id,
                         ...
                         cotrimoxazole_prophylaxis_start_dat as inhprophylaxis_started_date,
...
#                                         and
     ...
     tmp_vl_sent_date as (SELECT encounter_id,
                          ...
                          WHERE viral_load_sent_date is not null
                            and viral_load_sent_date <= '2024-09-30'),
     ...
     tmp_switch_sub_date as (SELECT encounter_id,
                                    ...
                                    ROW_NUMBER() OVER (PARTITION BY client_id ORDER BY follow_up_date DESC, encounter_id DESC) AS row_num
                             FROM FollowUp
                             WHERE follow_up_date <= '2024-09-30'
...
select tmp_address.patient_uuid,
       ...
       tmp_3.follow_up_status,

       tmp_3.follow_up_date,
       fn_gregorian_to_ethiopian_calendar(tmp_3.follow_up_date, 'Y-M-D')  as followupdate_et,
       fn_gregorian_to_ethiopian_calendar(tmp_3.art_start_date, 'Y-M-D')  as art_start_date,
       tmp_3.next_visit_date,
       fn_gregorian_to_ethiopian_calendar(tmp_3.next_visit_date, 'Y-M-D') as nextvisit_et,
