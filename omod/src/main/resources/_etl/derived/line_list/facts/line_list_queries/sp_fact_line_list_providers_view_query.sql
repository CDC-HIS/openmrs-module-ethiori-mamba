...
#                                         and
         ...
         tpt as (select client_id, tpt_status
                 ...
                 select client_id
                      , tpt_status
                 from tpt_bronze_6),
         tmp_latest_follow_up as (select follow_up_status,
                                         encounter_id,
                                         FollowUP.client_id,
                                         sex,
                                         date_of_birth,
         ...
         latest_follow_up as (select *
                              ...
                              where row_num = 1
                                ...
                                and sex = 'Female'
                                and TIMESTAMPDIFF(YEAR, date_of_birth, END_DATE) BETWEEN 25 AND 65),
         ...
         cx_base_clients as (select latest_follow_up.*,
                                    ...
                                    CASE
                                        ...
                                        WHEN (TIMESTAMPDIFF(DAY, prev_screening.via_date, END_DATE)) > 730
...
#                                           prev_screening.ccs_via_result = 'suspected cervical cancer'
                                            ...
                                            AND (prev_screening.ccs_treat_received_date is null
                                                or prev_screening.ccs_treat_received_date > END_DATE)
                                            and
                                             (prev_screening.date_patient_referred_out is null
                                                 or prev_screening.date_patient_referred_out > END_DATE)
                                            AND prev_screening.biopsy_result is null
                                        ...
                                        WHEN
                                            prev_screening.cytology_result = 'Negative result'
                                                and
                                            TIMESTAMPDIFF(DAY, prev_screening.cytology_result_date, END_DATE) >
                                            1095
                                            THEN 'Eligible Needs Re-Screening'
                                        ...
                                        WHEN (prev_screening.biopsy_result = 'Carcinoma in situ'
                                            ...
                                            AND (prev_screening.ccs_treat_received_date <= END_DATE
                                                or prev_screening.date_patient_referred_out <= END_DATE)
                                        ...
                                        WHEN
                                            ...
                                            'ASCUS (Atypical Squamous Cells of Undetermined Significance) on Pap Smear'
                                                ...
                                                and
                                            TIMESTAMPDIFF(DAY, prev_screening.colposcopy_exam_date, END_DATE) >
                                            1095
                                            THEN 'Eligible Needs Re-Screening'
...
#                                                  prev_screening.date_patient_referred_out <= REPORT_END_DATE)
                                    ...
                                    CASE
                                        ...
                                        WHEN
                                            (TIMESTAMPDIFF(DAY, prev_screening.via_date, END_DATE)) > 730 AND
