...
DROP PROCEDURE IF EXISTS sp_fact_line_list_ncd_screening_query_v2;

CREATE PROCEDURE sp_fact_line_list_ncd_screening_query_v2(IN REPORT_START_DATE DATE, IN REPORT_END_DATE DATE)
BEGIN
WITH art_history AS (SELECT client_id,
                                hiv_confirmed_date,
                                art_start_date,
