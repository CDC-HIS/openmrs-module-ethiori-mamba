...
DROP PROCEDURE IF EXISTS sp_fact_line_list_pediatric_age_out_query_v2;

CREATE PROCEDURE sp_fact_line_list_pediatric_age_out_query_v2(IN REPORT_START_DATE DATE, IN REPORT_END_DATE DATE)
BEGIN
WITH Follow_up AS (SELECT follow_up_date_followup_                            AS follow_up_date,
                              follow_up.client_id                                 AS patient_id,
                              follow_up.encounter_id                              AS encounter_id,
