...
DROP PROCEDURE IF EXISTS sp_fact_line_list_cxca_eligibility_query_v2;

CREATE PROCEDURE sp_fact_line_list_cxca_eligibility_query_v2(IN REPORT_END_DATE DATE)
BEGIN
WITH FollowUP AS (SELECT follow_up.encounter_id,
                             follow_up.client_id,
                             follow_up_date_followup_                        as follow_up_date,
