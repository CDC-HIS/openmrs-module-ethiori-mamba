...
DROP PROCEDURE IF EXISTS sp_fact_line_list_ict_contacts_query_v2;

CREATE PROCEDURE sp_fact_line_list_ict_contacts_query_v2(IN REPORT_START_DATE DATE, IN REPORT_END_DATE DATE)
BEGIN
WITH contact_list as (select g.client_id                                                          as index_client_id,
                                 contact.client_id,
                                 contact.elicited_date,
