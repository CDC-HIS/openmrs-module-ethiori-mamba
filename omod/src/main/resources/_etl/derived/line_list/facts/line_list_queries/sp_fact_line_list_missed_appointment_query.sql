...
DROP PROCEDURE IF EXISTS sp_fact_line_list_missed_appointment_query_v2;

CREATE PROCEDURE sp_fact_line_list_missed_appointment_query_v2(IN REPORT_END_DATE DATE)
BEGIN
WITH FollowUp AS (select follow_up.encounter_id,
                             follow_up.client_id,
                             CASE follow_up_status
