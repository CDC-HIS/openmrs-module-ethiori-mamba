...
BEGIN
    ...
    SELECT dc.patient_name                                                                  AS 'Patient Name',
                   ...
                   WHEN co.interval_month = 0 THEN
                       CASE
                           WHEN TIMESTAMPDIFF(YEAR, dc.date_of_birth, co.interval_end_date) < 15 AND
                                co.final_regimen LIKE '4%' AND
                                final_cohort_outcome IN ('Active', 'Active - Carry Forward Rx')
                               THEN 'On Original 1st Line Regimen'
                           WHEN TIMESTAMPDIFF(YEAR, dc.date_of_birth, co.interval_end_date) >= 15 AND
                                co.final_regimen LIKE '1%' AND
                                final_cohort_outcome IN ('Active', 'Active - Carry Forward Rx')
                               THEN 'On Original 1st Line Regimen'
                           ...
                           WHEN TIMESTAMPDIFF(YEAR, dc.date_of_birth, co.interval_end_date) < 15 AND
                                co.final_regimen LIKE '5%' AND
                                final_cohort_outcome IN ('Active', 'Active - Carry Forward Rx')
                               THEN 'On 2nd Line Regimen (Switched)'
                           WHEN TIMESTAMPDIFF(YEAR, dc.date_of_birth, co.interval_end_date) >= 15 AND
                                co.final_regimen LIKE '2%' AND
                                final_cohort_outcome IN ('Active', 'Active - Carry Forward Rx')
                               THEN 'On 2nd Line Regimen (Switched)'

                           WHEN TIMESTAMPDIFF(YEAR, dc.date_of_birth, co.interval_end_date) < 15 AND
                                co.final_regimen LIKE '6%' AND
                                final_cohort_outcome IN ('Active', 'Active - Carry Forward Rx')
                               THEN 'On 3rd Line Regimen (Switched)'
                           WHEN TIMESTAMPDIFF(YEAR, dc.date_of_birth, co.interval_end_date) >= 15 AND
                                co.final_regimen LIKE '3%' AND
                                final_cohort_outcome IN ('Active', 'Active - Carry Forward Rx')
                               THEN 'On 3rd Line Regimen (Switched)'
                   ...
                   WHEN co.interval_month = 36 THEN
                       CASE
                           WHEN TIMESTAMPDIFF(YEAR, dc.date_of_birth, co.interval_end_date) < 15 AND
                               ...
                               THEN 'On Original 1st Line Regimen'
                           WHEN TIMESTAMPDIFF(YEAR, dc.date_of_birth, co.interval_end_date) >= 15 AND
                                co.regimen LIKE '1%' AND final_cohort_outcome IN ('Active', 'Active - Carry Forward Rx')
                               THEN 'On Original 1st Line Regimen'
           ...
           MAX(CASE WHEN co.interval_month = 36 THEN co.treatment_end_date ELSE NULL END)   AS 'Last TX_Curr Date at 36 Months',
           MAX(CASE WHEN co.interval_month = 36 THEN co.treatment_end_date ELSE NULL END)   AS 'Last TX_Curr Date at 36 Months EC.',
