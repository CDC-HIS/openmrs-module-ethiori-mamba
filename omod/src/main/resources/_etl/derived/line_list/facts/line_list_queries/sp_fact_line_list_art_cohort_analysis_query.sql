...
DROP PROCEDURE IF EXISTS sp_fact_line_list_art_cohort_analysis_query_v2;

CREATE PROCEDURE sp_fact_line_list_art_cohort_analysis_query_v2(IN REPORT_START_DATE DATE, IN REPORT_END_DATE DATE)
BEGIN
WITH FollowUpEncounters AS (SELECT follow_up.encounter_id,
                                       follow_up.client_id                 AS PatientId,
                                       follow_up_status,
