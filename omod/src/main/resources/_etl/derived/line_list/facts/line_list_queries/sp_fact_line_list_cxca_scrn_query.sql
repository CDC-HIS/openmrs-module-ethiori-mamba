...
DROP PROCEDURE IF EXISTS sp_fact_line_list_cxca_scrn_query_v2;

CREATE PROCEDURE sp_fact_line_list_cxca_scrn_query_v2(IN REPORT_START_DATE DATE, IN REPORT_END_DATE DATE)
BEGIN
WITH FollowUp as (select follow_up.encounter_id,
                             follow_up.client_id,
                             cervical_cancer_screening_status          as cx_ca_screening_status,
