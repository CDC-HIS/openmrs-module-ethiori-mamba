...
DROP PROCEDURE IF EXISTS sp_fact_line_list_tx_tb_numerator_query;

CREATE PROCEDURE sp_fact_line_list_tx_tb_numerator_query(IN REPORT_START_DATE DATE,
...
DROP PROCEDURE IF EXISTS sp_fact_line_list_tx_tb_numerator_query_v2;

CREATE PROCEDURE sp_fact_line_list_tx_tb_numerator_query_v2(IN REPORT_START_DATE DATE,
                                                             IN REPORT_END_DATE DATE)
BEGIN
WITH FollowUp AS (select follow_up.encounter_id,
                             follow_up.client_id,
