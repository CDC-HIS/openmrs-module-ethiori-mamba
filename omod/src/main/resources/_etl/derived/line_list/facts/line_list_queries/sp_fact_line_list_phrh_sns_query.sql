...
DROP PROCEDURE IF EXISTS sp_fact_line_list_phrh_sns_query_v2;

CREATE PROCEDURE sp_fact_line_list_phrh_sns_query_v2(IN REPORT_START_DATE DATE, IN REPORT_END_DATE DATE, IN PHRH_CODE VARCHAR(255))
BEGIN
WITH provided_coupons AS (
        SELECT
            mps.client_id,
