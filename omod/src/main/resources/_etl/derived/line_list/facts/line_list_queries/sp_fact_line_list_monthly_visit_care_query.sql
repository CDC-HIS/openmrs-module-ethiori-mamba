...
DROP PROCEDURE IF EXISTS sp_fact_line_list_monthly_visit_care_query_v2;

CREATE PROCEDURE sp_fact_line_list_monthly_visit_care_query_v2(IN REPORT_START_DATE DATE, IN REPORT_END_DATE DATE,
                                                            IN STATUS TEXT)
BEGIN
WITH FollowUp AS (select follow_up.encounter_id,
                             follow_up.client_id,
