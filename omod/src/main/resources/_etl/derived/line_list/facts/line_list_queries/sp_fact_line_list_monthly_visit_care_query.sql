...
BEGIN
    ...
    SELECT ROW_NUMBER() OVER (ORDER BY patient_name)           as `#`,
           ...
           client.sex                                          as Sex,
           f_case.art_start_date                               as `ART Start Date in E.C`,
           f_case.art_start_date                               as `ART Start Date in G.C.`,
           f_case.follow_up_date                               as `Follow-up Date in E.C`,
           ...
           f_case.date_vl_requested                            as `VL Requested Date in E.C`,
           f_case.date_vl_requested                            as `VL Requested Date in G.C.`,
           f_case.date_vl_received                             as `VL Received Date in E.C`,
           ...
           f_case.dsd_assessment_date                          as `Current DSD Assessment Date in E.C`,
           f_case.dsd_assessment_date                          as `Current DSD Assessment Date in G.C.`,
           f_case.next_visit_date                              as `Next Visit Date in E.C`,
