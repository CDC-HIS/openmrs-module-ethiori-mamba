...
DROP PROCEDURE IF EXISTS sp_fact_line_list_child_cohort_analysis_query_v2;

CREATE PROCEDURE sp_fact_line_list_child_cohort_analysis_query_v2(IN REPORT_START_DATE DATE, IN REPORT_END_DATE DATE)
BEGIN
WITH HeiEnrolled AS (SELECT hei_enrollment.encounter_id                       as hei_encounter_id,
                                maternal_enrollment.encounter_id                  as mother_encounter_id,
                                linked_mother.identifier                          as mother_mrn,
