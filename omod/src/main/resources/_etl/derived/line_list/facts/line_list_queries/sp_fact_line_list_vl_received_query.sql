...
BEGIN
    WITH FollowUp AS (SELECT follow_up.client_id,
         ...
         vl_test_performed AS (SELECT patient_name                                        as `Patient Name`,
                                      ...
                                      art_start_date                                      as `ART Start Date in E.C`,
                                      vlperfdate.follow_up_date                           as `Follow-up Date in E.C`,
                                      ...
                                      vlperfdate.viral_load_sent_date                     as `Viral Load Sent Date`,
                                      vlperfdate.viral_load_perform_date                  as `VL Received Date`,
                                      TIMESTAMPDIFF(DAY, vlperfdate.viral_load_perform_date,
                                      ...
                                      latest_follow_up.next_visit_date                    as `Next Visit Date in E.C`,
                                      latest_follow_up.treatment_end_date                 as `Treatment End Date in E.C.`,
                                      mobile_no                                           as `Mobile No.`

                               FROM FollowUp
                                        INNER JOIN vl_performed_date as vlperfdate
