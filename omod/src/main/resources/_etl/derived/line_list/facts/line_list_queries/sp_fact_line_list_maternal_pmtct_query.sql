...
DROP PROCEDURE IF EXISTS sp_fact_line_list_maternal_pmtct_query_v2;

CREATE PROCEDURE sp_fact_line_list_maternal_pmtct_query_v2(IN REPORT_START_DATE DATE, IN REPORT_END_DATE DATE)
BEGIN
WITH Enrollment AS (SELECT client_id,
                               encounter_id,
                               antenatal_care_provider,
