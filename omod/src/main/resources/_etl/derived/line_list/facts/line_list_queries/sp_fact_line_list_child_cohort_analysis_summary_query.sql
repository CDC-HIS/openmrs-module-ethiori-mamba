...
DROP PROCEDURE IF EXISTS sp_fact_line_list_child_cohort_analysis_summary_query_v2;

CREATE PROCEDURE sp_fact_line_list_child_cohort_analysis_summary_query_v2(IN REPORT_START_DATE DATE, IN REPORT_END_DATE
    DATE)
BEGIN
WITH IntervalsDef AS (SELECT 0 AS interval_month
                          UNION ALL
