...
BEGIN
    ...
    CREATE INDEX idx_temp_followup_client ON temp_followup(client_id);

    -- 2. Materialize the tx_new logic
    DROP TEMPORARY TABLE IF EXISTS temp_tx_new;
    CREATE TEMPORARY TABLE temp_tx_new AS
    WITH tmp_latest_follow_up as (SELECT client_id,
                                         follow_up_date,
                                         encounter_id,
                                         follow_up_status,
                                         art_start_date,
         ...
         tx_new_tmp as (select latest_follow_up.client_id,
                               ...
                               latest_follow_up.follow_up_date,
                               first_follow_up.transferred_in,
                        ...
                        where latest_follow_up.art_start_date BETWEEN REPORT_START_DATE AND REPORT_END_DATE
...
-- 4 1 - 4 years, Male
    ...
    SELECT 'HIV_TX_NEW. 4'     AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 1 AND 4 AND sex = 'Male'
-- 6 1-4 year, Female-non-pregnant
    ...
    SELECT 'HIV_TX_NEW. 6'                 AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 1 AND 4 AND sex = 'Female'
-- 7 5-9 year, Male
    UNION ALL
    SELECT 'HIV_TX_NEW. 7'  AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 5 AND 9 AND sex = 'Male'
-- 9 5-9 year, Female-non-pregnant
    ...
    SELECT 'HIV_TX_NEW. 9'                 AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 5 AND 9 AND sex = 'Female'
-- 10 10-14 year, Male
    UNION ALL
    SELECT 'HIV_TX_NEW. 10'   AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 10 AND 14 AND sex = 'Male'
-- 12 10-14 year, Female-non-pregnant
    ...
    SELECT 'HIV_TX_NEW. 12'                  AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 10 AND 14 AND sex = 'Female'
-- 13 15-19 year, Male
    UNION ALL
    SELECT 'HIV_TX_NEW. 13'   AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 15 AND 19 AND sex = 'Male'
-- 14 15-19 year, Female-pregnant
    ...
    SELECT 'HIV_TX_NEW. 14'              AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 15 AND 19 AND sex = 'Female' AND pregnancy_status = 'Yes'
-- 15 15-19 year, Female-non-pregnant
    ...
    SELECT 'HIV_TX_NEW. 15'                  AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 15 AND 19 AND sex = 'Female' AND (pregnancy_status = 'No' or pregnancy_status is null)
-- 16 20-24 year, Male
    UNION ALL
    SELECT 'HIV_TX_NEW. 16'   AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 20 AND 24 AND sex = 'Male'
-- 17 20-24 year, Female-pregnant
    ...
    SELECT 'HIV_TX_NEW. 17'              AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 20 AND 24 AND sex = 'Female' AND pregnancy_status = 'Yes'
-- 18 20-24 year, Female-non-pregnant
    ...
    SELECT 'HIV_TX_NEW. 18'                  AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 20 AND 24 AND sex = 'Female' AND (pregnancy_status = 'No' or pregnancy_status is null)
-- 19 25-29 year, Male
    UNION ALL
    SELECT 'HIV_TX_NEW. 19'   AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 25 AND 29 AND sex = 'Male'
-- 20 25-29 year, Female-pregnant
    ...
    SELECT 'HIV_TX_NEW. 20'              AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 25 AND 29 AND sex = 'Female' AND pregnancy_status = 'Yes'
-- 21 25-29 year, Female-non-pregnant
    ...
    SELECT 'HIV_TX_NEW. 21'                  AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 25 AND 29 AND sex = 'Female' AND (pregnancy_status = 'No' or pregnancy_status is null)
-- 22 30-34 year, Male
    UNION ALL
    SELECT 'HIV_TX_NEW. 22'   AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 30 AND 34 AND sex = 'Male'
-- 23 30-34 year, Female-pregnant
    ...
    SELECT 'HIV_TX_NEW. 23'              AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 30 AND 34 AND sex = 'Female' AND pregnancy_status = 'Yes'
-- 24 30-34 year, Female-non-pregnant
    ...
    SELECT 'HIV_TX_NEW. 24'                  AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 30 AND 34 AND sex = 'Female' AND (pregnancy_status = 'No' or pregnancy_status is null)
-- 25 35-39 year, Male
    UNION ALL
    SELECT 'HIV_TX_NEW. 25'   AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 35 AND 39 AND sex = 'Male'
-- 26 35-39 year, Female-pregnant
    ...
    SELECT 'HIV_TX_NEW. 26'              AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 35 AND 39 AND sex = 'Female' AND pregnancy_status = 'Yes'
-- 27 35-39 year, Female-non-pregnant
    ...
    SELECT 'HIV_TX_NEW. 27'                  AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 35 AND 39 AND sex = 'Female' AND (pregnancy_status = 'No' or pregnancy_status is null)
-- 28 35-39 year, Male
    UNION ALL
    SELECT 'HIV_TX_NEW. 28'   AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 40 AND 44 AND sex = 'Male'
-- 29 40-44 year, Female-pregnant
    ...
    SELECT 'HIV_TX_NEW. 29'              AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 40 AND 44 AND sex = 'Female' AND pregnancy_status = 'Yes'
-- 30 40-44 year, Female-non-pregnant
    ...
    SELECT 'HIV_TX_NEW. 30'                  AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 40 AND 44 AND sex = 'Female' AND (pregnancy_status = 'No' or pregnancy_status is null)
-- 31 45-49 year, Male
    UNION ALL
    SELECT 'HIV_TX_NEW. 31'   AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 45 AND 49 AND sex = 'Male'
-- 32 45-49 year, Female-pregnant
    ...
    SELECT 'HIV_TX_NEW. 32'              AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 45 AND 49 AND sex = 'Female' AND pregnancy_status = 'Yes'
-- 33 45-49 year, Female-non-pregnant
    ...
    SELECT 'HIV_TX_NEW. 33'                  AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age BETWEEN 45 AND 49 AND sex = 'Female' AND (pregnancy_status = 'No' or pregnancy_status is null)
-- 34 >=50 year, Male
    UNION ALL
...
-- 36 >=50 year, Female-non-pregnant
    ...
    SELECT 'HIV_TX_NEW. 36'                 AS S_NO,
           ...
           COUNT(*)
    FROM temp_tx_new
    WHERE age >= 50 AND sex = 'Female' AND (pregnancy_status = 'No' or pregnancy_status is null);
