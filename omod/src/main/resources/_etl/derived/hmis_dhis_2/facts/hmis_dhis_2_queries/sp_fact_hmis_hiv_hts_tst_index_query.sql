...
-- 1 - 4 years, Male
    ...
    where hiv_test_date BETWEEN REPORT_START_DATE AND REPORT_END_DATE
      and hiv_test_result is not null
      and respondent_age BETWEEN 1 AND 4
      and sex = 'Male'
-- 1 - 4 years, Female
    UNION ALL
...
-- 5 - 9 years, Male
    ...
    where hiv_test_date BETWEEN REPORT_START_DATE AND REPORT_END_DATE
      and hiv_test_result is not null
      and respondent_age BETWEEN 5 AND 9
      and sex = 'Male'
-- 5 - 9 years, Female
    UNION ALL
...
-- 10 - 14 years, Male
    ...
    where hiv_test_date BETWEEN REPORT_START_DATE AND REPORT_END_DATE
      and hiv_test_result is not null
      and respondent_age BETWEEN 10 AND 14
      and sex = 'Male'
-- 10 - 14 years, Female
    UNION ALL
...
-- 15 - 19 years, Male
    ...
    where hiv_test_date BETWEEN REPORT_START_DATE AND REPORT_END_DATE
      and hiv_test_result is not null
      and respondent_age BETWEEN 15 AND 19
      and sex = 'Male'
-- 15 - 19 years, Female
    UNION ALL
...
-- 20 - 24 years, Male
    ...
    where hiv_test_date BETWEEN REPORT_START_DATE AND REPORT_END_DATE
      and hiv_test_result is not null
      and respondent_age BETWEEN 20 AND 24
      and sex = 'Male'
-- 20 - 24 years, Female
    UNION ALL
...
-- 25 - 29 years, Male
    ...
    where hiv_test_date BETWEEN REPORT_START_DATE AND REPORT_END_DATE
      and hiv_test_result is not null
      and respondent_age BETWEEN 25 AND 29
      and sex = 'Male'
-- 25 - 29 years, Female
    UNION ALL
...
-- 30 - 34 years, Male
    ...
    where hiv_test_date BETWEEN REPORT_START_DATE AND REPORT_END_DATE
      and hiv_test_result is not null
      and respondent_age BETWEEN 30 AND 34
      and sex = 'Male'
-- 30 - 34 years, Female
    UNION ALL
...
-- 35 - 39 years, Male
    ...
    where hiv_test_date BETWEEN REPORT_START_DATE AND REPORT_END_DATE
      and hiv_test_result is not null
      and respondent_age BETWEEN 35 AND 39
      and sex = 'Male'
-- 35 - 39 years, Female
    UNION ALL
...
-- 40 - 44 years, Male
    ...
    where hiv_test_date BETWEEN REPORT_START_DATE AND REPORT_END_DATE
      and hiv_test_result is not null
      and respondent_age BETWEEN 40 AND 44
      and sex = 'Male'
-- 40 - 44 years, Female
    UNION ALL
...
-- 45 - 49 years, Male
    ...
    where hiv_test_date BETWEEN REPORT_START_DATE AND REPORT_END_DATE
      and hiv_test_result is not null
      and respondent_age BETWEEN 45 AND 49
      and sex = 'Male'
-- 45 - 49 years, Female
    UNION ALL
