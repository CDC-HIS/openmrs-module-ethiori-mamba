...
DROP PROCEDURE IF EXISTS sp_dim_tx_new_datim_breast_feeding_status_query;

CREATE PROCEDURE sp_dim_tx_new_datim_breast_feeding_status_query(
...
SELECT COUNT(*) as Breastfeeding from tx_new where breast_feeding_status = 'Yes'
END //
