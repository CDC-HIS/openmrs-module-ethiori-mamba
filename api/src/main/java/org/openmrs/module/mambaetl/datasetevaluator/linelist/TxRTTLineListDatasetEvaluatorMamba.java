...
@Handler(supports = { TXRTTLineListDataSetDefinitionMamba.class })
public class TxRTTLineListDatasetEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(TxRTTLineListDatasetEvaluatorMamba.class);
    ...
    public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
        ...
        TXRTTLineListDataSetDefinitionMamba dataSetDefinitionMamba = (TXRTTLineListDataSetDefinitionMamba) dataSetDefinition;
	...
	private List<ProcedureCall> createProcedureCalls(TXRTTLineListDataSetDefinitionMamba dataSetDefinitionMamba) {
        ...
        return Collections.singletonList(
                new ProcedureCall("{call sp_fact_line_list_tx_rtt_query(?,?)}", statement -> {
