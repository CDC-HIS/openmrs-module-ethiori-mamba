...
public class CXCAEligibilityLineListDataSetEvaluator implements DataSetEvaluator {
	...
	private static final Log log = LogFactory.getLog(CXCAEligibilityLineListDataSetEvaluator.class);
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
		...
		CXCAEligibilityListDatasetDefinition cxcaEligibilityListDatasetDefinition = (CXCAEligibilityListDatasetDefinition) dataSetDefinition;
		...
		try (Connection connection = DataSetEvaluatorHelper.getDataSource().getConnection()) {
			...
			List<ProcedureCall> procedureCalls = createProcedureCalls(cxcaEligibilityListDatasetDefinition);
