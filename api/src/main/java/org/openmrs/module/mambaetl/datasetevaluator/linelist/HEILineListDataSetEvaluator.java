...
@Handler(supports = { HEILineListDatasetDefinition.class })
public class HEILineListDataSetEvaluator implements DataSetEvaluator {

    private static final Log log = LogFactory.getLog(HEILineListDataSetEvaluator.class);
    ...
    public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
        ...
        HEILineListDatasetDefinition heiLineListDatasetDefinition = (HEILineListDatasetDefinition) dataSetDefinition;
        SimpleDataSet data = new SimpleDataSet(dataSetDefinition, evalContext);
        ResultSetMapper resultSetMapper = new ResultSetMapper();

        ValidateDates(data, heiLineListDatasetDefinition.getStartDate(), heiLineListDatasetDefinition.getEndDate());
    ...
    private List<ProcedureCall> createProcedureCalls(HEILineListDatasetDefinition dataSetDefinitionMamba) {
        ...
        return Collections.singletonList(
                new ProcedureCall("{call sp_fact_line_list_hei_query(?,?)}", statement -> {
