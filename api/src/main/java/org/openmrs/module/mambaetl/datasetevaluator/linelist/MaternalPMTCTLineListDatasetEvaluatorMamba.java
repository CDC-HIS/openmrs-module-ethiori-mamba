...
@Handler(supports = { MaternalPMTCTLineListDataSetDefinitionMamba.class })
public class MaternalPMTCTLineListDatasetEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(MaternalPMTCTLineListDatasetEvaluatorMamba.class);
    ...
    public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
        ...
        MaternalPMTCTLineListDataSetDefinitionMamba dataSetDefinitionMamba = (MaternalPMTCTLineListDataSetDefinitionMamba) dataSetDefinition;
	...
	private List<ProcedureCall> createProcedureCalls(MaternalPMTCTLineListDataSetDefinitionMamba dataSetDefinitionMamba) {
        ...
        return Collections.singletonList(
                new ProcedureCall("{call sp_fact_line_list_maternal_pmtct_query(?,?)}", statement -> {
