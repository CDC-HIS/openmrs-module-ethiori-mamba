...
public class MotherCohortAnalysisLineListReportMamba implements ReportManager {
	...
	public String getUuid() {
		return "0eab8da6-4596-6754-we34-b173ea4d9c9c";
	}
	
	@Override
	public String getName() {
		return "ART COHORT - Mother Cohort Analysis LineList";
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		MotherCohortAnalysisLineListDataSetDefinitionMamba dataSetDefinitionMamba = new MotherCohortAnalysisLineListDataSetDefinitionMamba();
		dataSetDefinitionMamba.addParameters(getParameters());
		
		reportDefinition.addDataSetDefinition("Mother Cohort Analysis LineList",
	...
	public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
		ReportDesign design = ReportManagerUtil.createExcelDesign("d6c499b1-1ba7-2356-0g00-3141952c4942", reportDefinition);
