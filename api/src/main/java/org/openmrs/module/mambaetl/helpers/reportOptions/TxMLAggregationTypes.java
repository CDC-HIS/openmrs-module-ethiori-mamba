...
public enum TxMLAggregationTypes {
	TOTAL("TOTAL"), DIED("DIED"), LESS_THAN_THREE_MONTHS("LESS_THAN_THREE_MONTHS"), THREE_TO_FIVE_MONTHS(
	        "THREE_TO_FIVE_MONTHS"), MORE_THAN_SIX_MONTHS("MORE_THAN_SIX_MONTHS"), TRANSFERRED_OUT("TRANSFERRED_OUT"), REFUSED(
	        "REFUSED");
