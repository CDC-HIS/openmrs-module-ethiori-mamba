...
@Handler(supports = { ChildCohortAnalysisLineListDataSetDefinitionMamba.class })
public class ChildCohortAnalysisLineListDatasetEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(ChildCohortAnalysisLineListDatasetEvaluatorMamba.class);
    ...
    public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
        ...
        ChildCohortAnalysisLineListDataSetDefinitionMamba dataSetDefinitionMamba = (ChildCohortAnalysisLineListDataSetDefinitionMamba) dataSetDefinition;
	...
	private List<ProcedureCall> createProcedureCalls(ChildCohortAnalysisLineListDataSetDefinitionMamba dataSetDefinitionMamba) {
