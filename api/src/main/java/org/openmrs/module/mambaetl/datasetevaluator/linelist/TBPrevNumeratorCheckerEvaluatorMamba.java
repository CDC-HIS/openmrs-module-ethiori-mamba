...
@Handler(supports = { TBPrevNumeratorCheckerDataSetDefinitionMamba.class })
public class TBPrevNumeratorCheckerEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(TBPrevNumeratorCheckerEvaluatorMamba.class);
    ...
    public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
        ...
        TBPrevNumeratorCheckerDataSetDefinitionMamba dataSetDefinitionMamba = (TBPrevNumeratorCheckerDataSetDefinitionMamba) dataSetDefinition;
	...
	private List<ProcedureCall> createProcedureCalls(TBPrevNumeratorCheckerDataSetDefinitionMamba dataSetDefinitionMamba) {
