...
@Handler(supports = { PrEPLineListDataSetDefinitionMamba.class })
public class PrEPLineListDataSetEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(PrEPLineListDataSetEvaluatorMamba.class);
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
		...
		PrEPLineListDataSetDefinitionMamba definition = (PrEPLineListDataSetDefinitionMamba) dataSetDefinition;
