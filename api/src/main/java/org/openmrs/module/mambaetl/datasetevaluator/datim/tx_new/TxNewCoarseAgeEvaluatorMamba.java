...
public class TxNewCoarseAgeEvaluatorMamba implements DataSetEvaluator {
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext) throws EvaluationException {
		...
		if (txNewCoarseAgeDataSetDefinitionMamba.getStartDate() != null
		        && txNewCoarseAgeDataSetDefinitionMamba.getEndDate() != null
		        && txNewCoarseAgeDataSetDefinitionMamba.getStartDate().compareTo(
		            txNewCoarseAgeDataSetDefinitionMamba.getEndDate()) > 0) {
		...
		List<TXNewData> resultSet = getEtlNew(txNewCoarseAgeDataSetDefinitionMamba);
	...
	private List<TXNewData> getEtlNew(TxNewCoarseAgeDataSetDefinitionMamba txNewCoarseAgeDataSetDefinitionMamba) {
