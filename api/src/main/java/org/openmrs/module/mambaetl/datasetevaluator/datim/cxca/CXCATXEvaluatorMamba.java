...
@Handler(supports = { CXCATXDataSetDefinitionMamba.class })
public class CXCATXEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(CXCATXEvaluatorMamba.class);
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
		...
		CXCATXDataSetDefinitionMamba dataSetDefinitionMamba = (CXCATXDataSetDefinitionMamba) dataSetDefinition;
	...
	private List<ProcedureCall> createProcedureCalls(CXCATXDataSetDefinitionMamba dataSetDefinitionMamba) {
		...
		return Collections.singletonList(
                new ProcedureCall("{call sp_dim_cxca_tx_datim_query(?,?,?,?)}", statement -> {
