...
@Handler(supports = { TxTBNumeratorDataSetDefinitionMamba.class })
public class TxTBNumeratorEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(TxTBNumeratorEvaluatorMamba.class);
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
		...
		TxTBNumeratorDataSetDefinitionMamba dataSetDefinitionMamba = (TxTBNumeratorDataSetDefinitionMamba) dataSetDefinition;
	...
	private List<ProcedureCall> createProcedureCalls(TxTBNumeratorDataSetDefinitionMamba dataSetDefinitionMamba) {
