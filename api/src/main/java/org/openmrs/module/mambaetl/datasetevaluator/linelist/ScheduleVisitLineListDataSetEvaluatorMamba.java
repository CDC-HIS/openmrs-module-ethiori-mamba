...
@Handler(supports = { ScheduleVisitLineListDataSetDefinitionMamba.class })
public class ScheduleVisitLineListDataSetEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(ScheduleVisitLineListDataSetEvaluatorMamba.class);
