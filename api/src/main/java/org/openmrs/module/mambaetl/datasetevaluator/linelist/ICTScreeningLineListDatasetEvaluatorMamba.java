...
@Handler(supports = { ICTScreeningLineListDataSetDefinitionMamba.class })
public class ICTScreeningLineListDatasetEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(ICTScreeningLineListDatasetEvaluatorMamba.class);
    ...
    public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
        ...
        ICTScreeningLineListDataSetDefinitionMamba dataSetDefinitionMamba = (ICTScreeningLineListDataSetDefinitionMamba) dataSetDefinition;
	...
	private List<ProcedureCall> createProcedureCalls(ICTScreeningLineListDataSetDefinitionMamba dataSetDefinitionMamba) {
        ...
        return Collections.singletonList(
                new ProcedureCall("{call sp_fact_line_list_ict_screening_query(?,?)}", statement -> {
