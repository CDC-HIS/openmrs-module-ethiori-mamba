...
@Handler(supports = { NCDTreatmentLineListDataSetDefinitionMamba.class })
public class NCDTreatmentLineListDataSetEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(NCDTreatmentLineListDataSetEvaluatorMamba.class);
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
		...
		NCDTreatmentLineListDataSetDefinitionMamba ncdLineListDataSetDefinitionMamba = (NCDTreatmentLineListDataSetDefinitionMamba) dataSetDefinition;
	...
	private List<ProcedureCall> createProcedureCalls(NCDTreatmentLineListDataSetDefinitionMamba ncdLineListDataSetDefinitionMamba) {
		...
		return Collections.singletonList(
                new ProcedureCall("{call sp_fact_line_list_ncd_treatment_query(?,?)}", statement -> {
