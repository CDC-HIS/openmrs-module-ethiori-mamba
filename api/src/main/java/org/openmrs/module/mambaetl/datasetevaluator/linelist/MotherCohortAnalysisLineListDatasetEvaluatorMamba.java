...
@Handler(supports = { MotherCohortAnalysisLineListDataSetDefinitionMamba.class })
public class MotherCohortAnalysisLineListDatasetEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(MotherCohortAnalysisLineListDatasetEvaluatorMamba.class);
    ...
    public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
        ...
        MotherCohortAnalysisLineListDataSetDefinitionMamba dataSetDefinitionMamba = (MotherCohortAnalysisLineListDataSetDefinitionMamba) dataSetDefinition;
	...
	private List<ProcedureCall> createProcedureCalls(MotherCohortAnalysisLineListDataSetDefinitionMamba dataSetDefinitionMamba) {
        ...
        if (dataSetDefinitionMamba.getType().equalsIgnoreCase("LineList")){
            return Collections.singletonList(
                    new ProcedureCall("{call sp_fact_line_list_mother_cohort_analysis_query(?,?)}", statement -> {
                ...
                new ProcedureCall("{call sp_fact_line_list_mother_cohort_analysis_summary_query(?,?)}", statement -> {
                    statement.setDate(1, startDate);
                    statement.setDate(2, endDate);
                })
        );
