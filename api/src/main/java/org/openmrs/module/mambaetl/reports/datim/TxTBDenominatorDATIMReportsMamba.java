...
public class TxTBDenominatorDATIMReportsMamba implements ReportManager {
	...
	public String getName() {
		return "DATIM TREATMENT- TX_TB (Denominator)";
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		txTBNewArtTotalDenominatorDataSetDefinitionMamba
		...
		reportDefinition
		        .addDataSetDefinition(
		            ...
		            EthiOhriUtil.map(txTBNewArtTotalDenominatorDataSetDefinitionMamba,
		...
		reportDefinition.addDataSetDefinition("New on ART/Screen Positive", EthiOhriUtil.map(
		    txTBNewArtPositiveDenominatorDataSetDefinitionMamba, "startDate=${startDate},endDate=${endDate}"));
		...
		reportDefinition.addDataSetDefinition("New on ART/Screen Negative", EthiOhriUtil.map(
		    txTBNewArtNegativeDenominatorDataSetDefinitionMamba, "startDate=${startDate},endDate=${endDate}"));
		...
		reportDefinition.addDataSetDefinition("Already on ART/Screen Positive", EthiOhriUtil.map(
		    txTBPreArtPositiveDenominatorDataSetDefinitionMamba, "startDate=${startDate},endDate=${endDate}"));
		...
		reportDefinition.addDataSetDefinition("Already on ART/Screen Negative", EthiOhriUtil.map(
		    txTBPreArtNegativeDenominatorDataSetDefinitionMamba, "startDate=${startDate},endDate=${endDate}"));
		...
		reportDefinition.addDataSetDefinition("Disaggregated by Screen Type",
		    EthiOhriUtil.map(txTBScreenTypeDenominatorDataSetDefinitionMamba, "startDate=${startDate},endDate=${endDate}"));
		...
		reportDefinition
		        .addDataSetDefinition("Disaggregated by Specimen Sent", EthiOhriUtil.map(
		            txTBSpecimenSentDenominatorDataSetDefinitionMamba, "startDate=${startDate},endDate=${endDate}"));
		...
		reportDefinition.addDataSetDefinition("[Disagg of Specimen Sent] Diagnostic Test", EthiOhriUtil.map(
		    txTBDiagnosticTestDenominatorDataSetDefinitionMamba, "startDate=${startDate},endDate=${endDate}"));
		...
		reportDefinition.addDataSetDefinition("Disaggregated by Positive Result Returned", EthiOhriUtil.map(
		    txTBPositiveReturnedDenominatorDataSetDefinitionMamba, "startDate=${startDate},endDate=${endDate}"));
