...
@Handler(supports = { AHDLineListDataSetDefinitionMamba.class })
public class AHDLineListDataSetEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(AHDLineListDataSetEvaluatorMamba.class);
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
		...
		AHDLineListDataSetDefinitionMamba ahdLineListDataSetDefinitionMamba = (AHDLineListDataSetDefinitionMamba) dataSetDefinition;
	...
	private List<ProcedureCall> createProcedureCalls(AHDLineListDataSetDefinitionMamba dataSetDefinitionMamba) {
		...
		return Collections.singletonList(
                new ProcedureCall("{call sp_fact_line_list_ahd_query(?)}", statement -> {
