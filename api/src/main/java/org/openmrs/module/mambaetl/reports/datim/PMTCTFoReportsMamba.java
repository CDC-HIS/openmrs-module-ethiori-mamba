...
public class PMTCTFoReportsMamba implements ReportManager {
	...
	public ReportDefinition constructReportDefinition() {
		...
		reportDefinition.addDataSetDefinition("DSD: PMTCT_FO",
		...
		denominatorDataSet.addParameters(getParameters());
	...
	public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
		...
		ReportDesign design = ReportManagerUtil.createExcelDesign("f89d69a0-9222-4d2f-88a1-8eafb82d48f3",
				reportDefinition);
