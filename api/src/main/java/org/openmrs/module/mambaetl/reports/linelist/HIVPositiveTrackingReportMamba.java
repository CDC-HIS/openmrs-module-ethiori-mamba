...
@Component
public class HIVPositiveTrackingReportMamba implements ReportManager {
	
	@Override
	public String getUuid() {
		return "12324569-0202-4c18-920a-27ee765y1212";
	}
	...
	public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
		ReportDesign design = ReportManagerUtil.createExcelDesign("32326789-2121-4910-0909-8149b7696817", reportDefinition);
