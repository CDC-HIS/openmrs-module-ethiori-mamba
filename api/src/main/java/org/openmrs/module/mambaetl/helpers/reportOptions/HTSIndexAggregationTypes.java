...
public enum HTSIndexAggregationTypes {
	TESTING_OFFERED("TESTING_OFFERED"), TESTING_ACCEPTED("TESTING_ACCEPTED"), ELICITED("ELICITED"), KNOWN_POSITIVE(
	        "KNOWN_POSITIVE"), DOCUMENTED_NEGATIVE("DOCUMENTED_NEGATIVE"), NEW_POSITIVE("NEW_POSITIVE"), NEW_NEGATIVE(
	        "NEW_NEGATIVE"), ICT_TOTAL("ICT_TOTAL");
