...
public enum TxTBAggregationTypes {
	TOTAL("TOTAL"),NEW_ART_POSITIVE("NEW_ART_POSITIVE"), NEW_ART_NEGATIVE("NEW_ART_NEGATIVE"), PREV_ART_POSITIVE("PREV_ART_POSITIVE"), PREV_ART_NEGATIVE(
	        ...
	        "NUMERATOR_PREV"), NUMERATOR_TOTAL("NUMERATOR_TOTAL");
