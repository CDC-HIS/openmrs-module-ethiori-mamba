...
@Handler(supports = { TBPrevDenominatorCheckerDataSetDefinitionMamba.class })
public class TBPrevDenominatorCheckerEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(TBPrevDenominatorCheckerEvaluatorMamba.class);
    ...
    public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
        ...
        TBPrevDenominatorCheckerDataSetDefinitionMamba dataSetDefinitionMamba = (TBPrevDenominatorCheckerDataSetDefinitionMamba) dataSetDefinition;
	...
	private List<ProcedureCall> createProcedureCalls(TBPrevDenominatorCheckerDataSetDefinitionMamba dataSetDefinitionMamba) {
        ...
        return Collections.singletonList(
                new ProcedureCall("{call sp_dim_tb_prev_datim_denominator_query(?,?,?,?)}", statement -> {
                    ...
                    statement.setString(4, TBPrevAggregationTypes.DEBUG.getSqlValue());
                })
        );
    }
}
