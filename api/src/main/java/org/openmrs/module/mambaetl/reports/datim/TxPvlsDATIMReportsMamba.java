...
public class TxPvlsDATIMReportsMamba implements ReportManager {
    ...
    public ReportDefinition constructReportDefinition() {
        ...
        txCurrPvlsDataSetDefinitionNumeratorMamba.setDescription("Disaggregated by Age / Sex (Fine Disaggregate). Must complete finer disaggregates unless permitted by program.");
        reportDefinition.addDataSetDefinition("Disaggregated by Age / Sex (Fine Disaggregate). Must complete finer disaggregates unless permitted by program.",
        ...
        txCurrPvlsDataSetDefinitionDenominatorMamba.setDescription("Disaggregated by Age / Sex (Fine Disaggregate). Must complete finer disaggregates unless permitted by program.");
        reportDefinition.addDataSetDefinition("Disaggregated by Age / Sex (Fine Disaggregate). Must complete finer disaggregates unless permitted by program.",
