...
@Handler(supports = { HIVPositiveTrackingLineListDataSetDefinitionMamba.class })
public class HIVPositiveTrackingLineListDataSetEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(HIVPositiveTrackingLineListDataSetEvaluatorMamba.class);
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
		...
		try (Connection connection = DataSetEvaluatorHelper.getDataSource().getConnection()) {
			...
			List<ProcedureCall> procedureCalls = createProcedureCalls(_dataSetDefinitionMamba);
