...
@Handler(supports = { ARTRetentionDataSetDefinitionMamba.class })
public class RetentionLineListDataSetEvaluatorMamba implements DataSetEvaluator {
	
	private static final Log log = LogFactory.getLog(RetentionLineListDataSetEvaluatorMamba.class);
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext evalContext)
		...
		ARTRetentionDataSetDefinitionMamba ahdLineListDataSetDefinitionMamba = (ARTRetentionDataSetDefinitionMamba) dataSetDefinition;
